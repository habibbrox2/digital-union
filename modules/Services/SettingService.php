...
class SettingService
{
     ...
     */    public function getSystemSettings(): array
    {
        ...
        $check = @$this->mysqli->query("SHOW TABLES LIKE 'system_settings'");
        if (!$check || $check->num_rows === 0) {
            // Table doesn't exist — attempt auto-create
     ...
     * Schema mirrors database/migrations/001_create_system_settings.sql
     */
    ...
    public function uploadOrganizationLogo(array $file): array
    {
        ...
        $dbPath = normalize_file_path($dbPath);
    ...
    public function uploadUnionLogo(array $file, string $unionCode, int $unionId): array
    {
        ...
        return ['status' => 'success', 'path' => normalize_file_path('/uploads/unions/' . $fileName)];
    }
