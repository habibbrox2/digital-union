...
class AuthManager {
     ...
     * If not authenticated, redirects to login with a return URL so the user
     * is sent back to the page they were trying to access after logging in.
     */
    public function requireLogin(): void {
        if (!$this->isLoggedIn()) {
            ...
            if ($isAjax) {
                ...
                // Save the page they were trying to access so we can redirect back after login
