...
class UserModel {
    ...
    public function uploadProfilePicture($file) {
        ...
        if (move_uploaded_file($file['tmp_name'], $target)) {
            chmod($target, 0644);
            return normalize_file_path("/uploads/profiles/" . $fileName);
        }
    ...
    public function getUserDetails($userId) {
        $sql = "SELECT u.*, r.role_name,
                un.union_name_bn, un.union_name_en,
                un.division_name_bn, un.division_name_en,
                un.district_name_bn, un.district_name_en,
                un.upazila_name_bn, un.upazila_name_en
            FROM users u
